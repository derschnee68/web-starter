...
export default class TrainDocument extends Document {
  render() {
    return (
      <Html lang="en">
        <Head>
          ...
          <meta name="application-name" content="iSquare Train" />
          ...
          <meta name="apple-mobile-web-app-title" content="iSquare Train" />
          <link
...
TrainDocument.getInitialProps = async (ctx) => {
